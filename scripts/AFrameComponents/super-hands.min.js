 ...
 */require("./systems/super-hands-system.js"), require("./reaction_components/hoverable.js"), require("./reaction_components/grabbable.js"), require("./reaction_components/stretchable.js"), require("./reaction_components/drag-droppable.js"), require("./reaction_components/draggable.js"), require("./reaction_components/droppable.js"), require("./reaction_components/clickable.js"), AFRAME.registerComponent("super-hands", {
   ...
   */remove: function () { this.system.unregisterMe(this), this.unRegisterListeners(), this.hoverEls.length = 0, this.state.get(this.HOVER_EVENT) && this._unHover(this.state.get(this.HOVER_EVENT)), this.onGrabEndButton(), this.onStretchEndButton(), this.onDragDropEndButton() }, tick: function () {// closer objects and objects with no distance come later in list
      ...
      module.exports = {
         ...
         }, physicsEnd: function (a) { const b = this.constraints.get(a.detail.hand); b && (this.el.removeAttribute("constraint__" + b), this.constraints.delete(a.detail.hand)) }, physicsClear: function () { if (this.el.body) for (const a of this.constraints.values()) this.el.body.world.removeConstraint(a); this.constraints.clear() }, physicsIsConstrained: function (a) { return this.constraints.has(a) }, physicsIsGrabbing() { return 0 < this.constraints.size }
      };

   }, {}], 10: [function (require, module, exports) {
      "use strict";/* global AFRAME, THREE */const inherit = AFRAME.utils.extendDeep, buttonsCore = require("./prototypes/buttons-proto.js"), base = inherit({}, buttonsCore); AFRAME.registerComponent("stretchable", inherit(base, {
         schema: { usePhysics: { default: "ifavailable" }, invert: { default: !1 }, physicsUpdateRate: { default: 100 } }, init: function () { this.STRETCHED_STATE = "stretched", this.STRETCH_EVENT = "stretch-start", this.UNSTRETCH_EVENT = "stretch-end", this.stretched = !1, this.stretchers = [], this.scale = new THREE.Vector3, this.handPos = new THREE.Vector3, this.otherHandPos = new THREE.Vector3, this.start = this.start.bind(this), this.end = this.end.bind(this), this.el.addEventListener(this.STRETCH_EVENT, this.start), this.el.addEventListener(this.UNSTRETCH_EVENT, this.end) }, update: function () { this.updateBodies = AFRAME.utils.throttleTick(this._updateBodies, this.data.physicsUpdateRate, this) }, tick: function (a, b) {
            if (!this.stretched) return; this.scale.copy(this.el.getAttribute("scale")), this.stretchers[0].object3D.getWorldPosition(this.handPos), this.stretchers[1].object3D.getWorldPosition(this.otherHandPos); const c = this.handPos.distanceTo(this.otherHandPos); let d = 1;// scale update for all nested physics bodies (throttled)
            null !== this.previousStretch && 0 !== c && (d = Math.pow(c / this.previousStretch, this.data.invert ? -1 : 1)), this.previousStretch = c, null == this.previousPhysicsStretch && (this.previousPhysicsStretch = c), this.scale.multiplyScalar(d), this.el.setAttribute("scale", this.scale), this.updateBodies(a, b)
         }, remove: function () { this.el.removeEventListener(this.STRETCH_EVENT, this.start), this.el.removeEventListener(this.UNSTRETCH_EVENT, this.end) }, start: function (a) {
            this.stretched || this.stretchers.includes(a.detail.hand) || !this.startButtonOk(a) || a.defaultPrevented || (// already stretched or already captured this hand or wrong button
               this.stretchers.push(a.detail.hand), 2 === this.stretchers.length && (this.stretched = !0, this.previousStretch = null, this.previousPhysicsStretch = null, this.el.addState(this.STRETCHED_STATE)), a.preventDefault && a.preventDefault())
         }, end: function (a) { const b = this.stretchers.indexOf(a.detail.hand); a.defaultPrevented || !this.endButtonOk(a) || (-1 !== b && (this.stretchers.splice(b, 1), this.stretched = !1, this.el.removeState(this.STRETCHED_STATE), this._updateBodies()), a.preventDefault && a.preventDefault()) }, _updateBodies: function () {
            var a = Math.pow; if (!this.el.body || "never" === this.data.usePhysics) return; const b = this.previousStretch;// last visible geometry stretch
            let d = 1; if (null !== this.previousPhysicsStretch && 0 < b && (d = a(b / this.previousPhysicsStretch, this.data.invert ? -1 : 1)), this.previousPhysicsStretch = b, 1 !== d) { for (const a of this.el.childNodes) this.stretchBody(a, d); this.stretchBody(this.el, d) }
         }, stretchBody: function (a, b) {
            if (!a.body) return; let c, d; for (let e = 0; e < a.body.shapes.length; e++)// also move offset to match scale change
